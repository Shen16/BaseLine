    ...
    if columnType:  # If MULTI
        ...
        ## for Multi Line charts
           ...
           #Global Trends with rate of change
            ...
            summary2 = "Throughout the period, " + str(maxLine[0]) + " mostly maintained the highest " + "y-axis name" + " when compared to others" + " with a mean value of " + str(meanOfTopmost) + ", "
            ...
            if lineCount > 2:
                summary4 = "After " + str(maxLine[0]) + ", " + str(secondLine[0])+ " overall has the second highest values "+ ", with a mean value of " + str(secondLine[1]) + ", "
