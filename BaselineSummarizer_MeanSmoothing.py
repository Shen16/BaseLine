    ...
    if columnType:  # If MULTI
        ...
        # run line  
            ...
            while i < (len(yValueArrCorrectOrder)):
                ...
                if (old == 0 or old == 0.0):
                    old = 0.00000000001
                variance1 = float(yValueArrCorrectOrder[i]) - float(old)  # 2nd yVal- Prev yVal # Note that xValueArr and yValueArr are ordered such that the start values are written at the end of the array
            ...
            print("Refined Percent Change: " + str(refinedPercentChnage_array))
            ...
            print("mean_abs_refinedPercentChnage: " + str(mean_abs_refinedPercentChnage))
            ...
            print("constant_rate: " + str(constant_rate))
            print("significant_rate: " + str(significant_rate))
            print("gradually_rate: " + str(gradually_rate))
            print("rapidly_rate: " + str(rapidly_rate))
            ...
            if trendChangeIdx:  # if trendChangeIdx is not empty
                for i in trendChangeIdx:
                    if (x == 0):
                        ...
                        summary3 += " is " + rateOfChange + " " + directionArraySmoothed[
                                        i] + " from " + str(int(xValueArrCorrectOrder[0])) + " to " + str(int(xValueArrCorrectOrder[
                                        i + 1])) + ", "
                    elif(x>0 or x< len(trendChangeIdx)-1):
                        ...
                        summary3 += rateOfChange + " " + \
                                    directionArraySmoothed[i] + " from " + str(int(xValueArrCorrectOrder[
                                        trendChangeIdx[x - 1] + 1])) + " to " + str(int(xValueArrCorrectOrder[i + 1])) + ", "
                ...
                summary3 += "and lastly " + rateOfChange + " " + \
                            directionArraySmoothed[-1] + " from " + str(int(xValueArrCorrectOrder[
                                trendChangeIdx[-1] + 1])) + " to " + str(int(xValueArrCorrectOrder[-1])) + "."
            else:
                ...
                summary3 += " is " + rateOfChange + " " + \
                            directionArraySmoothed[-1] + " from " + str(int(xValueArrCorrectOrder[0])) + " to " + \
                            str(int(xValueArrCorrectOrder[-1])) + "."

            summaryArray.append(summary3)
            
            print("rateOfchange_array" + str(rateOfchange_array))
            ...
            if increaseDecrease(directionArraySmoothed[max_index]) != "stays the same":
                summary4 = "The steepest " + increaseDecrease(
                    directionArraySmoothed[max_index]) + " occurs in between the " + xLabel + " " + str(int(xValueArrCorrectOrder[
                               max_index])) + " and " + str(int(xValueArrCorrectOrder[max_index + 1])) + "."
                summaryArray.append(summary4)
            ...
            if len(max_index) > 1:
                ...
                while i < (len(max_index) - 1):
                    summary5 += " " + str(int(xValueArrCorrectOrder[max_index[i]])) + ", "
                    i = i + 1
                summary5 += "and " + str(int(xValueArrCorrectOrder[max_index[-1]]))
            else:
                summary5 += " " + str(int(xValueArrCorrectOrder[max_index[0]]))
            ...
            if len(min_index) > 1:
                ...
                while i < (len(min_index) - 1):
                    summary5 += " " + str(int(xValueArrCorrectOrder[min_index[i]])) + ", "
                    i = i + 1
                summary5 += "and " + str(int(xValueArrCorrectOrder[min_index[-1]]))
            else:
                summary5 += " " + str(int(xValueArrCorrectOrder[min_index[0]]))
